...
class FavoriteGymCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 遷移先はひとつ（ジム詳細）なので、タップも長押しも同じ処理にする。
    // Pressable は押下中の見た目だけを担い、タップ判定はこの InkWell に一本化する
    // （ジム名だけに別ハンドラを置くと二重遷移や「押せるのに遷移しない」の原因になる）。
    void openDetail() => NavigationHelper.toGymDetail(context, gym.id);
